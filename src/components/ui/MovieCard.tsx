      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            {year && <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11 }}>{year}</span>}
          </div>
        </div>
        ...
        {rank !== undefined && (
          <div style={{
            ...
            width: 26, height: 26, backgroundColor: A,
        ...
        {movie.mediaType === 'tv' && (
          <div style={{
            ...
            left: rank !== undefined ? 46 : 8,
            backgroundColor: 'rgba(0,30,60,0.82)', backdropFilter: 'blur(6px)',
            border: '1px solid rgba(0,153,255,0.5)',
            color: 'var(--accent)', fontSize: 10, fontWeight: 700,
            padding: '3px 8px', letterSpacing: '0.15em',
